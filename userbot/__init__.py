...
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "emon-ubot")
...
# Untuk Melihat Repo
REPO_NAME = os.environ.get("REPO_NAME") or "✨ᴇᴍᴏɴ-ᴜʙᴏᴛ✨"
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/843996dd8a889dd01109c.jpg"

# Default .helpme logo
HELP_LOGO = os.environ.get(
   "HELP_LOGO") or "https://telegra.ph/file/843996dd8a889dd01109c.jpg"
...
BOTLOG_MSG = os.environ.get(
    "BOTLOG_MSG") or "```║✨ᴇᴍᴏɴ-ᴜʙᴏᴛ✨ TELAH AKTIF!!🔥🔥║\n\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nJika Tidak Bisa Di .ping\nSilahkan Anda\nCek viewlogs\nPada heroku Anda.\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```"
...
#Import Userbot - Ported by EMONGRXS
from userbot import (
    ALIVE_NAME
)
