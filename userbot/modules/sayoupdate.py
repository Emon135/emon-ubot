    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari emon-ubot.`'
            )
            repo.__del__()
            return
...
CMD_HELP.update({
    'update':
    ".update"
    "\nUsage: Untuk Melihat Pembaruan Terbaru emon-ubot."
    "\n\n.update one"
    "\nUsage: Memperbarui emon-ubot."
    "\n\n.update all"
    "\nUsage: Memperbarui emon-ubot Dengan Cara Deploy Ulang."
})
