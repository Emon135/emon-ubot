...
async def killdabot(event):
    ...
    await event.edit("`Mematikan emon-ubot....`")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[✨ emon-ubot Repo](https://github.com/Emon135/emon-ubot/blob/emon-ubot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "**Hey**, I am using **✨ᴇᴍᴏɴ-ᴜʙᴏᴛ✨** \n"
        "卍━━━━━━━━━━━━━━━━━━━━━━卍\n"
        "➣ **Repo Userbot :** [ɢɪᴛʜᴜʙ](https://github.com/Emon135/emon-ubot)\n"
        "➣ **Owner Bot       :** [✞︎ᴇᴍᴏɴ [🇮🇩]](t.me/berakVbss)\n"
        "卍━━━━━━━━━━━━━━━━━━━━━━卍\n"
        "➣ **Instagram       :** [ɪɴsᴛᴀɢʀᴀᴍ](instagram.com/diiyyo2808)\n"
        "➣ **Support           :** [ᴄʜᴀɴɴᴇʟ](https://t.me/chipmunkchanel)\n"
        "卍━━━━━━━━━━━━━━━━━━━━━━卍\n"
    )
...
CMD_HELP.update({
    ...
    \n↳ : `.sleep`\
    \n  •  **Function : Biarkan emon-ubot tidur selama beberapa detik.",
    "shutdown": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.shutdown`\
    \n↳ : Mematikan bot",
    "repo": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.repo`\
    \n↳ : Menampilan link Repository emon-ubot.",
    "string": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.string`\
    \n↳: Menampilkan link String emon-ubot",
